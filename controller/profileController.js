...
exports.getProfile = async (req, res) => {
    try {
        ...
        const user = {
            ...
            middleName: (student?.middleName && student.middleName.trim()) || '',
        ...
        if (student) {
            ...
            console.log('   ├─ Middle Name:', student.middleName || 'Not set');
            ...
            console.log('⚠️ No student data found for user:', username);
...
exports.updateProfile = async (req, res) => {
    try {
        ...
        if (student) {
            ...
            console.log('⚠️ No student record found, cannot update profile');
...
exports.deleteProfile = async (req, res) => {
    try {
        ...
        console.log('🗑️ Account deleted for user ID:', userId);
