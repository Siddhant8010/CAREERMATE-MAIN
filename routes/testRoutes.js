...
router.get('/test-rules', (req, res) => {
  res.render('rulestest', { title: 'Test Rules - CareerMate' });
});
...
router.get('/api/tests', async (req, res) => {
  try {
    ...
    const aptitudeTest = {
      _id: 'aptitude',
      name: 'Aptitude Test',
      description: 'Comprehensive career aptitude assessment covering Physics, Chemistry, Mathematics, and Biology',
      testType: 'aptitude',
